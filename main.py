...
async def random_squad_name_command(interaction: discord.Interaction):
    ...
    adjectives = [
        "Маленькі", "Чорні", "Коренасті", "Сонливі", "Початкові", "Середні", "Грайливі",
        "Великі", "Білі", "Швидкі", "Повільні", "Хитрі", "Сміливі", "Боязкі",
        "Старі", "Молоді", "Досвідчені", "Невмілі", "Тихі", "Гучні",
        "Терпеливі", "Нетерпеливі", "Розумні", "Дурні", "Веселі", "Сумні",
        "Злі", "Добрі", "Холодні", "Гарячі", "Мокрі", "Сухі",
        "Голодні", "Ситі", "Втомлені", "Енергійні", "Спокійні", "Нервові",
        "Секретні", "Відкриті", "Таємничі", "Очевидні", "Складні", "Прості",
        "Дикі", "Домашні", "Вільні", "Заплутані", "Точні", "Випадкові"
    ]
    
    # Список іменників у множині (50 слів)
    nouns = [
        "десантники", "карлики", "танкісти", "космодесантники", "депутати", "члени",
        "солдати", "морпіхи", "льотчики", "снайпери", "сапери", "медики",
        "розвідники", "командири", "рядові", "сержанти", "офіцери", "генерали",
        "піхотинці", "артилеристи", "зв'язківці", "водії", "механіки", "кулеметники",
        "гранатометники", "парашутисти", "диверсанти", "штурмовики", "захисники", "нападники",
        "ветерани", "новобранці", "добровольці", "контрактники", "призовники", "резервісти",
        "бійці", "воїни", "герої", "легіонери", "гвардійці", "рейнджери",
        "коммандос", "спецназівці", "миротворці", "патрульні", "охоронці", "стрільці",
